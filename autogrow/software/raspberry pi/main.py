...
def choixDesPlantes():
    print(plantechoix)
    donnéesplante = pd.read_csv('/home/apoeon/Documents/autogrow/autogrow/software/raspberry pi/db.csv', usecols= [idPlante-1])
...
x=1
donnéesplante = pd.read_csv('/home/apoeon/Documents/autogrow/autogrow/software/raspberry pi/db.csv', usecols= [idPlante])
